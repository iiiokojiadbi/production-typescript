...
describe('classNames', () => {
  ...
  test('модами hovered scrollable', () => {
    ...
    expect(classNames('someClass', ['class1', 'class2'], { hovered: true, scrollable: true }))
      .toBe(expected);
  });
  ...
  test('модами hovered', () => {
    ...
    expect(classNames('someClass', ['class1', 'class2'], { hovered: true, scrollable: false }))
      .toBe(expected);
  });
  ...
  test('модами scrollable вместе с hovered undefined', () => {
    ...
    expect(classNames('someClass', ['class1', 'class2'], { hovered: undefined, scrollable: true }))
      .toBe(expected);
  });
});
